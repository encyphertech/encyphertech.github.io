...
// GOOGLE MAP
var	$googlemap_latitude 	= 28.68442,
	$googlemap_longitude	= 77.28598,
	$googlemap_zoom		= 13;
	...
	(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
		  ...
		  ga('create', 'UA-50453254-2', 'encypher.in');
		  ga('send', 'pageview');
...
function _topNav() {
	...
	function topMain() {
		...
		if(_scrollTop > 0) {
			...
			jQuery('header#topNav a.logo, #hire').stop().animate({ 'line-height':'0', 'margin-top':'-7px'},400);
			jQuery('#header_shadow').stop().animate({ 'top':'30px'},400);/* just a little visible */
			jQuery('#hire img').stop().animate({ 'height':'43px'},400);
		...
		if(window.topNavSmall === true && _scrollTop < 3) {
			...
			jQuery('header#topNav a.logo, #hire').stop().animate({ 'line-height':'50px', 'margin-top':'0'},400);
			jQuery('#header_shadow').stop().animate({ 'top':'92px'},400);
			jQuery('#hire img').stop().animate({ 'height':'61px'},400);
			window.topNavSmall = false;
		}
